        ...
        <div className="shrink-0 p-5 border-b border-slate-800 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 font-mono uppercase mt-1">
              Rol {role} · Elige un jugador convocado
            </p>
          </div>
          <button
            type="button"
            ...
            players.map((player) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center border border-slate-800 shrink-0 group-hover:border-blue-500/30">
                    <img
